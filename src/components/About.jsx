...
const About = () => {
	const lines = [
		...
		{ id: 6, text: "", className: "" },
		{ id: 7, text: "> Rakhman.interests", className: "" },
		{
			id: 8,
		...
		{ id: 9, text: "", className: "" },
		{ id: 10, text: "> Rakhman.education", className: "" },
		{
			id: 11,
		...
		{ id: 13, text: "> Rakhman.skills", className: "" },
		{
			id: 14,
			text: `["JavaScript", "Python", "React", "Node", "Express", "git", "Tailwind", "MongoDB", "Mongoose", "Typescript", "Wordpress", "Java"]`,
			className: "text-macYellow",
		},
